/* ============================================================
   S NEW ROOF INC. — SHARED BRAND LOGO SVG
   White version for dark backgrounds (header, footer)
   Single source of truth — used by Header and Footer
   ============================================================ */

export default function BrandLogoWhite({ height = 38 }: { height?: number }) {
  return (
    <svg
