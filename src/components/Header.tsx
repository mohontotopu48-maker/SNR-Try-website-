...
function BrandLogoWhite() {
  return (
    ...
    >
      <defs>
        <style>{`
          .hdr-wst0 { fill: #FFFFFF; }
          .hdr-wst1 { fill: none; stroke: none; }
          .hdr-wst2 { fill: #f68c1f; }
          .hdr-wst3 { fill: #FFFFFF; }
        `}</style>
      </defs>
      {/* Shield background plate — invisible on dark bg, no fill/stroke */}
      <path className="hdr-wst1" d="M219.03,417.15l82.1,16.74c3.17.67,6.6.59,9.79-.05l82.44-16.54c6.1-1.23,10.21-4.63,10.21-8.46v-25.64c0-3.82-4.08-7.21-10.15-8.45l-82.45-15.92c-3.19-.65-6.66-.64-9.84.02l-82.07,16.38c-6.01,1.26-10.03,4.63-10.03,8.42v25.08c0,3.78,4.01,7.15,10,8.41Z" />
      {/* Shield body silhouette — white for dark bg */}
      <g>
        <path className="hdr-wst3" d="M305.79,436.36c-1.76,0-3.46-.17-5.07-.51l-82.09-16.73c-7.05-1.48-11.6-5.56-11.6-10.38v-25.08c0-4.83,4.56-8.9,11.62-10.38l82.09-16.38c1.72-.36,3.53-.54,5.37-.54s3.56.18,5.26.52l82.43,15.92c7.05,1.44,11.77,5.62,11.77,10.41v25.64c0,4.81-4.75,9-11.81,10.42l-82.44,16.54c-1.83.37-3.69.55-5.52.55h0Z" />
        {/* Orange border outline — stays brand orange */}
        <path className="hdr-wst2" d="M306.11,358.36c1.64,0,3.28.16,4.86.48l82.45,15.92c6.07,1.24,10.15,4.63,10.15,8.45v25.64c0,3.83-4.11,7.23-10.21,8.46l-82.44,16.54c-1.67.33-3.4.51-5.13.51-1.58,0-3.15-.15-4.66-.47l-82.1-16.74c-5.99-1.26-10-4.63-10-8.41v-25.08c0-3.79,4.02-7.16,10.03-8.42l82.07-16.38c1.61-.34,3.3-.51,4.98-.51M306.11,354.36c-1.98,0-3.93.2-5.8.59l-82.04,16.37c-8.06,1.69-13.25,6.53-13.25,12.34v25.08c0,5.8,5.17,10.64,13.18,12.33l82.13,16.74c1.72.36,3.56.55,5.46.55s3.96-.2,5.92-.59l82.44-16.54c8.15-1.64,13.42-6.5,13.42-12.38v-25.64c0-5.86-5.24-10.71-13.35-12.36l-82.49-15.93c-1.79-.36-3.69-.55-5.62-.55h0Z" />
      </g>
      {/* Text characters — white for dark background */}
      <g>
        <path className="hdr-wst0" d="M231.58,409.83h-11.56c-.75,0-1.4-.27-1.93-.8-.54-.53-.81-1.17-.81-1.92v-10.17l5.46,3.23v4.22h6.12v-3.34l-10.13-6.12c-.96-.56-1.44-1.36-1.44-2.4v-6.91c0-.75.27-1.39.81-1.92.54-.53,1.18-.8,1.93-.8h11.6c.75,0,1.39.27,1.92.8.53.53.8,1.17.8,1.92v9.46l-5.44-3.28v-3.45h-6.16v2.65l10.25,6.19c.86.58,1.3,1.35,1.31,2.33v7.6c0,.75-.27,1.39-.8,1.92s-1.17.8-1.92.8Z" />
        <path className="hdr-wst0" d="M265.2,409.81h-4.39l-6.7-13v13h-5.44v-26.89h4.39l6.68,12.95v-13h5.46v26.95Z" />
        <path className="hdr-wst0" d="M282.2,409.81h-15.65v-26.95h15.65v5.46h-10.21v5.29h8.65v5.46h-8.65v5.27h10.21v5.46Z" />
        <path className="hdr-wst0" d="M304.94,409.79h-5.31l-2.23-9.5-2.21,9.5h-5.31l-6.32-26.87,5.59-.02,3.38,14.39,2.08-8.88-1.28-5.5,2.57-.02v-.02l.02.02h3l3.38,14.39,3.38-14.41,5.57.04-6.31,26.87Z" />
        <path className="hdr-wst0" d="M342.44,409.85l-5.44-.09.04-1.46c.03-.46.04-1.27.04-2.42,0-1.84-.21-3.31-.62-4.41-.58-1.58-1.67-2.38-3.28-2.42h-2.16v10.77h-5.44v-26.95h11.5c1.36,0,2.54.49,3.54,1.47.99.98,1.49,2.17,1.49,3.57v6.08c0,1.31-.44,2.44-1.31,3.38.5.84.87,1.73,1.12,2.67.24.94.4,1.89.48,2.83.07.94.11,1.83.11,2.66l-.06,4.32ZM336.66,393.58v-5.25h-5.65v5.25h5.65Z" />
        <path className="hdr-wst0" d="M355.28,409.81h-6.31c-1.41,0-2.62-.5-3.62-1.51s-1.5-2.21-1.5-3.61v-16.7c0-1.4.5-2.61,1.51-3.61,1.01-1.01,2.21-1.51,3.61-1.51h6.31c1.4,0,2.6.5,3.61,1.51,1.01,1.01,1.51,2.21,1.51,3.61v16.7c0,1.4-.5,2.61-1.5,3.61s-2.21,1.51-3.62,1.51ZM354.94,404.35v-16.03h-5.63v16.03h5.63Z" />
        <path className="hdr-wst0" d="M373.18,409.81h-6.31c-1.41,0-2.62-.5-3.62-1.51s-1.5-2.21-1.5-3.61v-16.7c0-1.4.5-2.61,1.51-3.61,1.01-1.01,2.21-1.51,3.61-1.51h6.31c1.4,0,2.6.5,3.61,1.51,1.01,1.01,1.51,2.21,1.51,3.61v16.7c0,1.4-.5,2.61-1.5,3.61s-2.21,1.51-3.62,1.51ZM372.84,404.35v-16.03h-5.63v16.03h5.63Z" />
        <path className="hdr-wst0" d="M385.11,409.81h-5.46v-26.95h15.67v5.46h-10.21v5.29h8.65v5.46h-8.65v10.73Z" />
      </g>
    </svg>
  );
}
...
export default function Header() {
  ...
  return (
    <>
      ...
      >
        <a href="#" className="snr-mobile-nav-link" onClick={() => setMobileOpen(false)}>Home</a>
        <a href="#services" className="snr-mobile-nav-link" onClick={() => setMobileOpen(false)}>Services</a>
        <a href="#gallery" className="snr-mobile-nav-link" onClick={() => setMobileOpen(false)}>Gallery</a>
        <a href="#faq" className="snr-mobile-nav-link" onClick={() => setMobileOpen(false)}>FAQ</a>
        <a href="#contact" className="snr-mobile-nav-link" onClick={() => setMobileOpen(false)}>Contact</a>
