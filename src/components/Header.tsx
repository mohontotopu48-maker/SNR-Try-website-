...
/* Inline SVG Logo from snr_hm_pg_icon.svg — rendered at small scale in header */
function BrandLogo({ size = 36 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
      viewBox="80 340 450 120"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      aria-hidden="true"
    >
      <path
        d="M219.03,417.15l82.1,16.74c3.17.67,6.6.59,9.79-.05l82.44-16.54c6.1-1.23,10.21-4.63,10.21-8.46v-25.64c0-3.82-4.08-7.21-10.15-8.45l-82.45-15.92c-3.19-.65-6.66-.64-9.84.02l-82.07,16.38c-6.01,1.26-10.03,4.63-10.03,8.42v25.08c0,3.78,4.01,7.15,10,8.41Z"
        stroke="#111111"
        strokeWidth="8"
        strokeMiterlimit="10"
        fill="none"
      />
      <path
        d="M306.11,358.36c1.64,0,3.28.16,4.86.48l82.45,15.92c6.07,1.24,10.15,4.63,10.15,8.45v25.64c0,3.83-4.11,7.23-10.21,8.46l-82.44,16.54c-1.67.33-3.4.51-5.13.51-1.58,0-3.15-.15-4.66-.47l-82.1-16.74c-5.99-1.26-10-4.63-10-8.41v-25.08c0-3.79,4.02-7.16,10.03-8.42l82.07-16.38c1.61-.34,3.3-.51,4.98-.51"
        fill="#F68C1F"
      />
      <path
        d="M231.58,409.83h-11.56c-.75,0-1.4-.27-1.93-.8-.54-.53-.81-1.17-.81-1.92v-10.17l5.46,3.23v4.22h6.12v-3.34l-10.13-6.12c-.96-.56-1.44-1.36-1.44-2.4v-6.91c0-.75.27-1.39.81-1.92.54-.53,1.18-.8,1.93-.8h11.6c.75,0,1.39.27,1.92.8.53.53.8,1.17.8,1.92v9.46l-5.44-3.28v-3.45h-6.16v2.65l10.25,6.19c.86.58,1.3,1.35,1.31,2.33v7.6c0,.75-.27,1.39-.8,1.92s-1.17.8-1.92.8Z"
        fill="#111111"
      />
      <path
        d="M265.2,409.81h-4.39l-6.7-13v13h-5.44v-26.89h4.39l6.68,12.95v-13h5.46v26.95Z"
        fill="#111111"
      />
      <path
        d="M282.2,409.81h-15.65v-26.95h15.65v5.46h-10.21v5.29h8.65v5.46h-8.65v5.27h10.21v5.46Z"
        fill="#111111"
      />
      <path
        d="M304.94,409.79h-5.31l-2.23-9.5-2.21,9.5h-5.31l-6.32-26.87,5.59-.02,3.38,14.39,2.08-8.88-1.28-5.5,2.57-.02v-.02l.02.02h3l3.38,14.39,3.38-14.41,5.57.04-6.31,26.87Z"
        fill="#111111"
      />
      <path
      ...
      />
      <path
        d="M355.28,409.81h-6.31c-1.41,0-2.62-.5-3.62-1.51s-1.5-2.21-1.5-3.61v-16.7c0-1.4.5-2.61,1.51-3.61,1.01-1.01,2.21-1.51,3.61-1.51h6.31c1.4,0,2.6.5,3.61,1.51,1.01,1.01,1.51,2.21,1.51,3.61v16.7c0,1.4-.5,2.61-1.5,3.61s-2.21,1.51-3.62,1.51ZM354.94,404.35v-16.03h-5.63v16.03h5.63Z"
        fill="#111111"
      />
      <path
        d="M373.18,409.81h-6.31c-1.41,0-2.62-.5-3.62-1.51s-1.5-2.21-1.5-3.61v-16.7c0-1.4.5-2.61,1.51-3.61,1.01-1.01,2.21-1.51,3.61-1.51h6.31c1.4,0,2.6.5,3.61,1.51,1.01,1.01,1.51,2.21,1.51,3.61v16.7c0,1.4-.5,2.61-1.5,3.61s-2.21,1.51-3.62,1.51ZM372.84,404.35v-16.03h-5.63v16.03h5.63Z"
        fill="#111111"
      />
      <path
        d="M385.11,409.81h-5.46v-26.95h15.67v5.46h-10.21v5.29h8.65v5.46h-8.65v10.73Z"
        fill="#111111"
      />
    </svg>
  );
    ...
    <>
      <header className="snr-header" role="banner">
        <div className="snr-header-inner">
          {/* Brand with inline SVG Logo */}
          <a href="#" className="snr-brand" aria-label="S New Roof Inc. — Home" style={{ flexDirection: 'row', alignItems: 'center', gap: '10px' }}>
            <BrandLogo size={40} />
